...
public class MultidimensionalArray {
    ...
    private static final int MIN_SIZE_OF_ARRAY_FOR_EXTREMUM = 3;
     ...
     * Value should be "inside" of matrix and have 8 neighbours
     */
    ...
    public static boolean areValidConditionsForExtremum(double[][] array, int indI, int indJ) {
        return array.length >= MIN_SIZE_OF_ARRAY_FOR_EXTREMUM
                && array[0].length >= MIN_SIZE_OF_ARRAY_FOR_EXTREMUM
